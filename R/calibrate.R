...
calibrate_outputs <- function(output,
  ...
  adj <- dplyr::bind_rows(
                  ...
                  .expand(naomi_mf$calendar_quarter4, "population"),
                  .expand(naomi_mf$calendar_quarter4, "plhiv"),
                  .expand(naomi_mf$calendar_quarter4, "art_current_residents"),
                  .expand(naomi_mf$calendar_quarter4, "art_current"),
                  .expand(naomi_mf$calendar_quarter4, "untreated_plhiv_num"),
                  .expand(naomi_mf$calendar_quarter4, "plhiv_attend"),
                  .expand(naomi_mf$calendar_quarter4, "untreated_plhiv_attend"),
                  .expand(naomi_mf$calendar_quarter4, "unaware_plhiv_num"),
                  .expand(naomi_mf$calendar_quarter4, "aware_plhiv_num"),
                  .expand(naomi_mf$calendar_quarter4, "unaware_plhiv_attend"),
                  .expand(naomi_mf$calendar_quarter4, "aware_plhiv_attend"),
                  .expand(naomi_mf$calendar_quarter4, "infections"),

                  .expand(naomi_mf$calendar_quarter5, "population"),
                  .expand(naomi_mf$calendar_quarter5, "plhiv"),
                  .expand(naomi_mf$calendar_quarter5, "art_current_residents"),
                  .expand(naomi_mf$calendar_quarter5, "art_current"),
                  .expand(naomi_mf$calendar_quarter5, "untreated_plhiv_num"),
                  .expand(naomi_mf$calendar_quarter5, "plhiv_attend"),
                  .expand(naomi_mf$calendar_quarter5, "untreated_plhiv_attend"),
                  .expand(naomi_mf$calendar_quarter5, "unaware_plhiv_num"),
                  .expand(naomi_mf$calendar_quarter5, "aware_plhiv_num"),
                  .expand(naomi_mf$calendar_quarter5, "unaware_plhiv_attend"),
                  .expand(naomi_mf$calendar_quarter5, "aware_plhiv_attend"),
                  .expand(naomi_mf$calendar_quarter5, "infections"),

                  .expand(naomi_mf$calendar_quarter6, "population"),
                  .expand(naomi_mf$calendar_quarter6, "plhiv"),
                  .expand(naomi_mf$calendar_quarter6, "art_current_residents"),
                  .expand(naomi_mf$calendar_quarter6, "art_current"),
                  .expand(naomi_mf$calendar_quarter6, "untreated_plhiv_num"),
                  .expand(naomi_mf$calendar_quarter6, "plhiv_attend"),
                  .expand(naomi_mf$calendar_quarter6, "untreated_plhiv_attend"),
                  .expand(naomi_mf$calendar_quarter6, "unaware_plhiv_num"),
                  .expand(naomi_mf$calendar_quarter6, "aware_plhiv_num"),
                  .expand(naomi_mf$calendar_quarter6, "unaware_plhiv_attend"),
                  .expand(naomi_mf$calendar_quarter6, "aware_plhiv_attend"),
                  .expand(naomi_mf$calendar_quarter6, "infections"),
                )
...
#' Helper functions for implementing calibration
#'
#' @param proportion_raw vector of initial input proportions
...
#' `proportion_raw` adjusted by a fixed odds ratio.
#'
#' For function interface convenience, the parameter `target_val`
#' may be a single number or a vector with the same value
#' repeated (typically of same length as `proportion_raw` and
#' `denominator_new`), but the value must be identical and only
...
calibrate_logistic_adjust_numerator <- function(theta, l, d) plogis(l + theta) * d
...
calibrate_logistic_one <- function(proportion_raw,
  ...
  logit_adjustment <- calculate_logit_adjustment(proportion_raw, denominator_new, target_val)
  calibrate_logistic_adjust_numerator(logit_adjustment, qlogis(proportion_raw), denominator_new)
}
