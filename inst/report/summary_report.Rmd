...
#-------------------------------------------------------------------------------
p1 <- naomi::map_outputs(naomi_output = outputs, 
                         indicator = "plhiv",
                         age = "Y015_999", 
                         sex_disag = "both", 
                         colour_palette = "red",
...
# # By lowest area_level
#-------------------------------------------------------------------------------
p2 <- naomi::map_outputs(naomi_output = outputs, 
...
# # By lowest area_level
#-------------------------------------------------------------------------------
p3 <- naomi::map_outputs(naomi_output = outputs, 
...
# # By lowest area_level
#-------------------------------------------------------------------------------
p4 <- naomi::map_outputs(naomi_output = outputs, 
...
# # By lowest area_level
#-------------------------------------------------------------------------------
p5 <- naomi::map_outputs(naomi_output = outputs, 
...
# # By lowest area_level
#-------------------------------------------------------------------------------
p6 <- naomi::map_outputs(naomi_output = outputs, 
                         indicator = "incidence",
                         age = "Y015_049", 
                         sex_disag = "both", 
                         colour_palette = "blue",
