...
```{r, echo = FALSE, results= 'asis'}
cat(paste0("Naomi is a statistal model that estimates district-level HIV indicators from Spectrum file **", spectrum_file,"**",
...
and survey data from several sources, inlcuding:
...
Further techincal information about the Naomi model is available at the end of this report.
