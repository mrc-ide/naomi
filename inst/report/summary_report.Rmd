...
if(grepl("\\.rds$", params$outputs)) {
  
  model_object <- readRDS(a_hintr_output_calibrated$model_output_path)
...
if(grepl("\\.zip$", params$outputs)) {
  ...
  if("fit/calibration_options.csv" %in% calibration_files$Name) {
    calibration_options <- unz(output_zip, "fit/calibration_options.csv")
    calibration_options <- readr::read_csv(calibration_options)
    calibration_options <- split(calibration_options$value, calibration_options$option)
  } else {
...
pop_pyramid_outputs <- function(disag_data,
  ...
  if(lang == "fr" ){
    ...
    dat$sex <- factor(dat$sex, levels = c("hommes","femmes"))
...
```{r, echo=FALSE,warning = FALSE, out.width  =  "90%", results = 'asis', include = print_fr, eval = print_fr}
...
```{r, echo=FALSE,warning = FALSE, out.width  =  "90%", results = 'asis', include = print_en, eval = print_en}
...
```{r, echo=FALSE,warning = FALSE, out.width  =  "90%", out.height=  "100%", results = 'asis', include = print_en, eval = print_en}
...
```{r, echo=FALSE,warning = FALSE, out.width  =  "90%", out.height=  "100%", results = 'asis', include = print_fr, eval = print_fr}
...
```{r, echo = FALSE, warning = FALSE, message= FALSE, out.width = "90%", fig.height = 3, fig.width = 6, include = print_fr, eval = print_fr}
#-------------------------------------------------------------------------------
...
```{r, echo = FALSE, warning = FALSE, message= FALSE, out.width = "90%", fig.height = 3, fig.width = 6, include = print_en, eval = print_en}
...
``` {r, echo=FALSE, warning = FALSE, result = "asis", fig.height = height, fig.width = 12, include = print_en, eval = print_en}  
...
``` {r, echo=FALSE, warning = FALSE, result = "asis", fig.height = height, fig.width = 12, include = print_fr, eval = print_fr}
