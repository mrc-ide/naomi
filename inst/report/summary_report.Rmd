...
if(sum(lengths(include$anc_art)) > 0) {
...
if(sum(lengths(include$anc_prev)) > 0) {
...
cat(paste0("This report summarises the **", area_level_label, "-level** HIV indicators for **", country,"** from the Naomi model as of **", quarter_t2, "**."), sep = "\n")
```
