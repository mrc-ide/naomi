---
params:
  outputs: "/var/folders/vk/s5m946h57g3dk4rm43k1zk2m0000gn/T//RtmpQx5p42/file551d122c769a.rds"
  lang: "en"
output:
  html_document:
    css: styles.css
...
#-------------------------------------------------------------------------------
anc_t1 <- !is.null(outputs$fit$data_options$anc_prev_year_t1)
anc_t2 <- !is.null(outputs$fit$data_options$anc_prev_year_t2)

if(anc_t1 && anc_t2) {
  t1 <- outputs$fit$data_options$anc_prev_year_t1
  t2 <- outputs$fit$data_options$anc_prev_year_t2

  #  Scatter plot ANC prevalence
  fig1 <-  scatter_plotly(data,
                          ind = "anc_prevalence_age_matched",
                          quarter = calendar_quarter1,
                          input_data = paste0("ANC ", t1) ,
