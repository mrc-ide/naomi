...
#' surveys
survey_meta <- readRDS(system.file("extdata/survey/survey_meta.rds", package = "naomi"))
survey_regions <- readRDS(system.file("extdata/survey/survey_regions.rds", package = "naomi"))
survey_clusters <- readRDS(system.file("extdata/survey/survey_clusters.rds", package = "naomi"))
survey_individuals <- readRDS(system.file("extdata/survey/survey_individuals.rds", package = "naomi"))
survey_biomarker <- readRDS(system.file("extdata/survey/survey_biomarker.rds", package = "naomi"))

survey_hiv_indicators <- readRDS(system.file("extdata/survey/survey_hiv_indicators.rds", package = "naomi"))
```
